...
public class ProjectService {
    ...
    public Project updateProject(String id, Project updatedData, String userId, boolean isAdmin) {
        Project existingProject = projectRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Proyecto no encontrado"));

        // Verificación de seguridad: dueño, colaborador o administrador pueden editar
    ...
    public void deleteProject(String id, String ownerId, boolean isAdmin) {
        Project existingProject = projectRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Proyecto no encontrado"));

        // Solo el dueño o administrador puede eliminar el proyecto
        if (!existingProject.getOwnerId().equals(ownerId) && !isAdmin) {
            throw new RuntimeException("Solo el propietario o un administrador puede eliminar este proyecto");
        }
